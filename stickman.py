...
class Game:
    def __init__(self):
        ...
        self.game_over_text = self.canvas.create_text(
            250, 250, text="YOU WIN!", font=("Times", 30), state="hidden", fill="red"
        )
        self.out = self.canvas.create_text(
            58, 22, text="EXIT", font=("Times", 7), fill="red"
        )
...
class StickFigureSprite(Sprite):
    def __init__(self, g):
        ...
        self.image = g.canvas.create_image(
    ...
    def move(self):
        ...
        for sprite in self.game.sprites:
            ...
            if (
                ...
                and falling
                and self.y == 0
                and c.y2 < self.game.canvas_height
                and collided_bottom(1, c, sprite_co)
            ):
                falling = False
...
games = Game()
form1 = PlatformSprite(
    games, PhotoImage(file="resources/platform1.gif"), 0, 480, 100, 10
)
form2 = PlatformSprite(
    games, PhotoImage(file="resources/platform1.gif"), 150, 440, 100, 10
)
form3 = PlatformSprite(
    games, PhotoImage(file="resources/platform1.gif"), 300, 400, 100, 10
)
form4 = PlatformSprite(
    games, PhotoImage(file="resources/platform1.gif"), 300, 160, 100, 10
)
form5 = PlatformSprite(
    games, PhotoImage(file="resources/platform2.gif"), 175, 350, 66, 10
)
form6 = PlatformSprite(
    games, PhotoImage(file="resources/platform2.gif"), 50, 300, 66, 10
)
form7 = PlatformSprite(
    games, PhotoImage(file="resources/platform2.gif"), 170, 120, 66, 10
)
form8 = PlatformSprite(
    games, PhotoImage(file="resources/platform2.gif"), 45, 60, 66, 10
)
form9 = PlatformSprite(
    games, PhotoImage(file="resources/platform3.gif"), 170, 250, 32, 10
)
form10 = PlatformSprite(
    games, PhotoImage(file="resources/platform3.gif"), 230, 200, 32, 10
)
